...
export class SettingService {
	...
	async getLoyaltyConfig() {
		const keys = [
			'loyalty_bronze_threshold', 'loyalty_silver_threshold',
			'loyalty_gold_threshold', 'loyalty_diamond_threshold',
			'loyalty_bronze_rate', 'loyalty_silver_rate',
			'loyalty_gold_rate', 'loyalty_diamond_rate'
		];
